...
description: System architecture and component design for Hubshift
navigation:
  icon: i-lucide-network
seo:
  title: Hubshift System Architecture
  description: Understand how Hubshift components connect and interact
---
