...
description: Complete guide to shift management including creation, allocation, and scheduling
navigation:
  icon: i-lucide-clock
seo:
  title: Hubshift Shift Workflow
  description: Step-by-step guide to shift workflow including shift types, creation, allocation, and management
---
