...
description: Complete guide to reporting, tracking, and managing incidents
navigation:
  icon: i-lucide-alert-triangle
seo:
  title: Hubshift Incident Management Workflow
  description: Step-by-step guide to incident management workflow including AI intake, investigation, status management, and closure
---
